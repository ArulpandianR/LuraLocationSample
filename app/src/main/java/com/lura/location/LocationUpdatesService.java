...
public class LocationUpdatesService extends Service {
     ...
     */
    public void requestLocationUpdates(float smallestDisplacement) {
        Log.i(TAG, "Requesting location updates");
        Utils.setRequestingLocationUpdates(this, true);
        startService(new Intent(getApplicationContext(), LocationUpdatesService.class));
        try {
            mFusedLocationClient.requestLocationUpdates(createLocationRequest(smallestDisplacement),
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "My channels")
     ...
     */
    private LocationRequest createLocationRequest(float smallestDisplacement) {
    ...
    private void saveServer(final Long time) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                loc.setCreatedAt(DateFormat.getDateTimeInstance().format(time));
                loc.setLatitude(latitude);
                loc.setLongitude(longitude);

                HmanLocationDatabase.getInstance(LocationUpdatesService.this).daoAccess().insertTask(loc);
                return null;
            }
        }.execute();
    }
